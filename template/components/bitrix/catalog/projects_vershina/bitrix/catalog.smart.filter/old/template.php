...
<div class="bx-filter filter bx_filter_vertical">
  <div class="bx-filter-section container-fluid">
    <form name="<?echo $arResult[" FILTER_NAME"]."_form"?>" action="<?echo $arResult["FORM_ACTION"]?>" method="get" class="smartfilter">
				...
				//not prices
						foreach($arResult["ITEMS"] as $key=>$arItem)
						{
							...
							if (
								...
								continue;
								?>
        <div class="bx-filter-parameters-box item <?if ($arItem[" DISPLAY_EXPANDED"]=="Y" ):?>bx-active
          ...
          <div class="bx-filter-block" data-role="bx_filter_block" <?if ($arItem["DISPLAY_EXPANDED"]=="Y" ):?>
            ...
            <div class="row bx-filter-parameters-box-container sorting__row">
              ...
              <?
								...
								?>
              <?$fil_min = number_format($arItem["VALUES"]["MIN"]["VALUE"], $precision, ".", "");
								$fil_max = number_format($arItem["VALUES"]["MAX"]["VALUE"], $precision, ".", "");?>
              <div class="range">
                <span>
                  <input class="min-price" type="text" name="<?echo $arItem[" VALUES"]["MIN"]["CONTROL_NAME"]?>"
                  id="
                ...
                <span><input class="max-price" type="text" name="<?echo $arItem[" VALUES"]["MAX"]["CONTROL_NAME"]?>"
                  id="
                  <?echo $arItem["VALUES"]["MAX"]["CONTROL_ID"]?>"
                  placeholder="
              ...
              <div class="col-xs-10 col-xs-offset-1 bx-ui-slider-track-container">
                <div class="bx-ui-slider-track toddler" id="drag_track_<?=$key?>">
                  ...
                  <div class="bx-ui-slider-range" id="drag_tracker_<?=$key?>" style="left: 0;right: 0;">
                    <a class="point point_left" style="left:0;" href="javascript:void(0)"
                      id="left_slider_<?=$key?>"></a>
                    <a class="point point_right" style="right:0;" href="javascript:void(0)"
                      id="right_slider_<?=$key?>"></a>
                  </div>
                </div>
              </div>
              ...
              <div class="col-xs-12">
                <div class="bx-filter-select-container">
                  <div class="bx-filter-select-block"
                    ...
                    <input style="display: none" type="radio" name="<?=$arCur["CONTROL_NAME_ALT"]?>" id="<? echo "
                      all_".$arCur["CONTROL_ID"] ?>"
                    value=""
                    />
                    <?foreach ($arItem["VALUES"] as $val => $ar):?>
                    <input style="display: none" type="radio" name="<?=$ar["CONTROL_NAME_ALT"]?>"
                      id="<?=$ar["CONTROL_ID"]?>" value="<? echo $ar[" HTML_VALUE_ALT"] ?>"
                    ...
                    <div class="bx-filter-select-popup" data-role="dropdownContent" style="display: none;">
                      <ul>
                        ...
                        <?
													...
													?>
                        <li>
                          <label for="<?=$ar["CONTROL_ID"]?>" class="bx-filter-param-label<?=$class?>"
              ...
              <?foreach($arItem["VALUES"] as $val => $ar):?>
              <label data-role="label_<?=$ar["CONTROL_ID"]?>" class="custom_radio <? echo $ar[" DISABLED"] ? 'disabled'
                : '' ?>" for="
                <? echo $ar["CONTROL_ID"] ?>">
              ...
              <?
								...
								<?
												...
												?>
									<a href="/ru/news/"><label data-role="label_all_arrFilter_2106_4204683263" class="custom_checkbox                 " for="all_arrFilter">
                <input  class="showall<?=$arItem[ID]?>" <?=$addcheck ?> type="checkbox" name="checkall<?=$arItem[ID]?>"  value="Y" name="all_arrFilter" >
                <span></span>
                <p>
                  Все статьи                </p>
              </label></a>
              <?foreach($arItem["VALUES"] as $val => $ar):?>
              <label data-role="label_<?=$ar["CONTROL_ID"]?>"  class="custom_checkbox <? echo $ar["CHECKED"]? 'checked': '' ?>
      ...
      <div class="row apply__buttons">
        <div class="col-xs-12 bx-filter-button-box">
          <div class="bx-filter-block">
            <div class="item">
              <input class=" bottomrightbutton" type="submit" id="set_filter" name="set_filter"
                value="<?=GetMessage("CT_BCSF_SET_FILTER")?>" />
              <input class=" bottomrightbutton" type="submit" id="del_filter" name="del_filter"
