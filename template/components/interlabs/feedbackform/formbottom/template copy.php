...
?>
    ...
    <!-- <div class="container h-[718px] sm:h-[647px] text-center  flex items-center justify-center flex-col" id='formSuccess'>
        ...
        <a href="/" class="button button-primary w-fit relative">
...
<div class="sm:max-w-[321px] col-span-4">
		...
		Сотрудничество </h2>
			   ...
			   Благодарим за отправку формы! Наши специалисты свяжутся с Вами в ближайшее время!
			   </p>
    
		<? } else if (isset($arResult['validateErrors']) && count($arResult['validateErrors']) > 0) { ?>
					<div>
